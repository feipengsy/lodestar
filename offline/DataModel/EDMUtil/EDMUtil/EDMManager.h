...
class EDMManager {
    ...
    public:
        ...
        // Given default path, get default priority
        int getPriorityWithPath(const std::string& path);
        ...
        // Given default path, get headerName
        std::string getHeaderNameWithPath(const std::string& name);
        // Given header name, get event name
        EDMRegistration::StringVector getEventNameWithHeader(const std::string& name);
        // Given default path, get event name
        EDMRegistration::StringVector getEventNameWithPath(const std::string& path);
        // Book a event type
    ...
    private:
        ...
        EDMRegistration* getRegWithPath(const std::string& path);
